...
```
docker pull netbox-community/device-type-library-import
```
...
```
docker run -e "NETBOX_URL=http://netbox:8080/" -e "NETBOX_TOKEN=98765434567890" netbox-community/device-type-library-import
```
